...
from crawUnit.core import CRAWLABUNIT_TMP
from crawUnit.core.config import config
from crawUnit.core.request import Request
from crawUnit.utils.scrapy import get_scrapy_cfg, get_items_fields, get_pipelines, get_spider_filepath
...
class Client(object):
    ...
    def upload_customized_spider(directory=None, name=None, col=None, display_name=None, command=None, id=None):
        ...
        target_path = os.path.join(CRAWLABUNIT_TMP, name or os.path.basename(directory)) + '.zip'
